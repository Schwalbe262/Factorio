...
set FACTORIO_AI_VLLM_ARGS=--max-model-len 4096 --gpu-memory-utilization 0.90 --enforce-eager
set FACTORIO_AI_VLLM_USE_FLASHINFER_SAMPLER=0
set FACTORIO_AI_VLLM_PORT=8000
set FACTORIO_AI_VLLM_STARTUP_SECONDS=420

echo [factorio-ai] Starting or reusing 1-GPU Qwen 9B A6000 Slurm worker...
