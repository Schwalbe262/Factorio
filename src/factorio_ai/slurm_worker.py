        ...
        rows.append(
            {
                ...
                "warnings": _compact_value(sandbox.get("warnings"), string_limit=140, list_limit=4),
...
def _compact_layout_candidate(value: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "sandbox_validation": {
            ...
            "warnings": _compact_value(sandbox_validation.get("warnings"), string_limit=140, list_limit=4),
